package com.zch.autoconfigure.token;

import com.zch.autoconfigure.ZchProperties;
import com.zch.autoconfigure.token.resolver.TokenIdHandlerMethodArgumentResolver;
import com.zch.autoconfigure.token.service.JwtTokenService;
...
public class TokenAutoConfiguration {
    ...
    @Bean
    public TokenService<String> jwtTokenService(ZchProperties zchProperties) {
        return JwtTokenService.of(zchProperties.getToken().getJwt());
    }
